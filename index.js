...
// const uri = `mongodb+srv://coffee_monstar:RqenKSihcDiWpDBQ@cluster0.rhmlrci.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
// 
app.listen(port, () => {
    console.log(`coffe is getting hotter ${port}`)
})
